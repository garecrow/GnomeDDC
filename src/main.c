...
static GtkWidget *build_sidebar(AppWindow *self) {
    ...
    gtk_widget_add_css_class(category_label, "gnomeddc-sidebar-category");
    ...
    gtk_widget_add_css_class(scrolled, "gnomeddc-sidebar-scroller");
...
static void ensure_app_styles(void) {
    ...
    if (g_once_init_enter(&initialized)) {
        const gchar *css =
            ...
            "  padding-bottom: 24px;"
            "}"
            ".gnomeddc-window .gnomeddc-sidebar-category {"
            "  font-weight: 600;"
            ...
            "}"
            ".gnomeddc-window .gnomeddc-sidebar-scroller {"
            "  background-color: #f6f5f4;"
            "}"
            ".gnomeddc-window .gnomeddc-sidebar-scroller > viewport {"
            ...
            "}"
            ".gnomeddc-window .gnomeddc-sidebar-list row:hover:not(:selected) {"
