...
class MonitorStore(GLib.Object):
    """Keeps monitor and VCP state in sync with the service."""

    __gsignals__ = {
        "monitors-changed": (GLib.SIGNAL_RUN_LAST, None, ()),
        "vcp-updated": (GLib.SIGNAL_RUN_LAST, None, (int, int)),
        "error": (GLib.SIGNAL_RUN_LAST, None, (str,)),
    }
